...
module.exports = { session: process.env.SESSION_ID || '',
    ...
    CAPTION : process.env.CAPTION || "DADMARK-MD",
    ...
    BOT : process.env.BOT_NAME || 'DADMARK MD',
    URL : process.env.BOT_MENU_LINKS || 'https://i.imgur.com/VclUrit.jpeg',
    URL: process.env.URL || "https://i.imgur.com/VclUrit.jpeg",
